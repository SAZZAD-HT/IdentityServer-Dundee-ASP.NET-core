...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SiteProjects.Models.Database.DailyAllocation", b =>
                {
                    b.Property<int>("AllotId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("AllotId"));

                    b.Property<DateTime>("ActionDate")
                        .HasMaxLength(200)
                        .HasColumnType("datetime2");

                    b.Property<float>("AllocationAmount")
                        .HasMaxLength(200)
                        .HasColumnType("real");
                    ...
                    b.ToTable("DailyAllocation");
                });

            modelBuilder.Entity("SiteProjects.Models.Database.DailyExpensesHeader", b =>
                {
                    ...
                    b.ToTable("DailyExpensesHeader");
                });

            modelBuilder.Entity("SiteProjects.Models.Database.DailyExpensesRow", b =>
                {
                    b.Property<int>("ERowId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ERowId"));

                    b.Property<string>("Description")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<DateOnly>("ExpenseId")
                        .HasColumnType("date");
            ...
            modelBuilder.Entity("SiteProjects.Models.Database.ImagesExpenses", b =>
                {
